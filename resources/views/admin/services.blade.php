...
@section('content')
    ...
    <div class="datatables">
        ...
        <ul class="nav nav-pills p-3 mb-4 rounded align-items-center card flex-row gap-3">
            <form class="position-relative input-group flex-grow-1 w-auto" id="serviceSearchForm">
                ...
                <div class="col-md-6 col-lg-4 service-item">
                    <div class="card rounded-2 overflow-hidden hover-img">
                        <div class="position-relative">
                            <a href="javascript:void(0)"><img src="{{ asset($service->thumbnail) }}"
                        ...
                        <div class="card-body p-4">
                            <span
                                class="badge text-bg-light fs-2 rounded-4 py-1 px-2 lh-sm mt-3">{{ $service->icon }}</span>
    ...
    <script>
        $(document).ready(function() {
            $('#searchButton').click(function() {
                var query = $('#text-srh').val(); // Get the search input value

                if (query.trim() === '') {
                    $('#servicesContainer').html('<p>Please enter a search term.</p>');
                    return;
                }

                $.ajax({
                    url: '/admin/search-service', // Your backend search route
                    type: 'GET', // Use GET method for searching
                    data: {
                        query: query,
                        _token: '{{ csrf_token() }}',
                    },
                    success: function(response) {
                        ...
                        if (response.length > 0) {
                            ...
                            <div class="col-md-6 col-lg-4 service-item">
                                <div class="card rounded-2 overflow-hidden hover-img">
                                    <div class="position-relative">
                                        <a href="javascript:void(0)"><img src="${service.thumbnail}" class="card-img-top rounded-0" alt="..." loading="lazy"></a>
                                        ...
                                        <div class="mt-9 me-9 position-absolute top-0 end-0">
                                            <a class="btn mb-1 waves-effect waves-light bg-primary-subtle text-light d-flex align-items-center justify-content-center p-2 fs-4 rounded-circle" href="javascript:void(0)" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-title="Show/Hide">
                                                <i class="ti ti-eye"></i>
                                            </a>
                                            <a class="btn mb-1 waves-effect waves-light bg-secondary-subtle text-light d-flex align-items-center justify-content-center p-2 fs-4 rounded-circle" href="javascript:void(0)" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-title="Edit">
                                                <i class="ti ti-pencil"></i>
                                            </a>
                                            <a class="btn mb-1 waves-effect waves-light bg-danger-subtle text-danger d-flex align-items-center justify-content-center p-2 fs-4 rounded-circle" href="javascript:void(0)" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-title="Delete">
                                                <i class="ti ti-trash"></i>
                                            </a>
                                        </div>
                                         <img src="assets/images/profile/user-1.jpg" alt=""
