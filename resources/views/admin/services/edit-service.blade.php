    ...
    <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
        <div class="card-body px-4 py-3">
            <div class="row align-items-center">
                <div class="col-9">
                    <h4 class="fw-semibold mb-8">Edit Service</h4>
        ...
        <div class="card-body">
            ...
            <form id="serviceForm">
                ...
                <div class="row">
                            ...
                            <div class="card-body">
                                ...
                                <div class="text-center">
                                    <img id="thumbnailPreview"
                                        src="{{ asset('admins_services_thumbnails/' . $service['thumbnail']) }}"
                                        alt="" class="img-fluid rounded-5" width="500" height="220">
                        ...
                        <div class="form-floating">
                            <select class="form-control text-capitalize" id="icon_img" name="icon_img" required>
                                ...
                                @foreach ($icons as $icon)
                                    <option value="{{ $icon }}"
                                        {{ old('icon_img', $service->icon_img ?? '') == $icon ? 'selected' : '' }} class="text-capitalize">
                                        {{ $icon }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-md-6">
                        <div class="form-floating">
                            <textarea class="form-control h-auto" id="description" name="description" rows="5" placeholder="" required>{{ $service['description'] }}</textarea>
                        ...
                        <div class="d-md-flex align-items-center mt-3">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" name="status" id="status"
                                    value="{{ $service['status'] }}" {{ $service['status'] ? 'checked' : '' }}>
        ...
        $(document).ready(function() {
            ...
            $('#resetThumbnailBtn').click(function() {
                ...
                $('#thumbnailPreview').attr('src',
                    "{{ asset('admins_services_thumbnails/' . $service['thumbnail']) }}");
            });
            ...
            $('#serviceForm').on('submit', function(e) {
                ...
                $.ajax({
                    url: `{{ url('admin/services/serviceUpdate') }}/{{ $service['id'] }}`,
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
