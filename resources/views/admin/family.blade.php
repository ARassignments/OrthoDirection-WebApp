                    ...
                    render: function(data, type, row) {
                        ...
                        return `<div class="d-flex align-items-center">
                                    <img src="${profileImg}" class="rounded-circle"
                                        width="40" height="40">
                                    <div class="ms-3">
                                        <h6 class="fs-4 fw-semibold text-capitalize mb-0"><a href="{{ url('admin/family/familyDetail') }}/${row.id}">${data}</a></h6>
                    ...
                    <div class="row justify-content-center w-100">
                        <div class="col-lg-12">
                            <div class="text-center">
                                ...
                                <h3 class="fw-semibold mb-3 text-dark">Family Members Not Found!!!</h3>
