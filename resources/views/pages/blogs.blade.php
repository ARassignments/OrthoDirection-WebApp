            ...
            <div class="col-lg-4 col-md-12 col-sm-12 sidebar-side">
                <div class="blog-sidebar default-sidebar mr_10">
                    ...
                    <div class="sidebar-widget category-widget">
                        ...
                        <div class="widget-content">
                            <ul class="category-list clearfix">
                                ...
                                <li><a href="blog-details.html">Dental Clinic</a></li>
                                <li><a href="blog-details.html">Neurosurgery</a></li>
                                <li><a href="blog-details.html">Medical</a></li>
                                <li><a href="blog-details.html">Pediatrics</a></li>
                                <li><a href="blog-details.html">Modern Laboratory</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="sidebar-widget category-widget archives-widget">
                        ...
                        <div class="widget-content">
                            <ul class="category-list clearfix">
                                <li><a href="blog-details.html">December 2021</a></li>
                                <li><a href="blog-details.html">October 2021</a></li>
                                <li><a href="blog-details.html">January 2022</a></li>
                                <li><a href="blog-details.html">October 2022</a></li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="blog-classic-content">
                    ...
                    <div class="news-block-one">
                        <div class="inner-box">
                            ...
                            <div class="lower-content">
                                ...
                                <h3><a href="blog-details.html">What Causes Inherited Retinal Diseases?</a></h3>
                                <p>Tincidunt Maur nemi sit Interdum praesento eget morbi lacinia volutpat pellentesque Tincidunt aurna suspit.</p>
                                <div class="link">
                                    <a href="blog-details.html"><span>Read More</span></a>
                                </div>
                    ...
                    <div class="pagination-wrapper pt_20">
                        <ul class="pagination clearfix">
                            ...
                            <li><a href="blog-2.html"><i class="icon-36"></i></a></li>
                        </ul>
                    </div>
                </div>
            </div>
