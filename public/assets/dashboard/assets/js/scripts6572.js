            ...
            a.forEach((t) => {
                e.Dropdown.load(t, n),
                    t.addEventListener("click", function (s) {
                        s.preventDefault(),
                            e.Win.width < i &&
                                (e.Dropdown.toggle(t, o),
                                e.Dropdown.closeSiblings(t, o, n, r));
                    });
            });
        });
    let s = {
    ...
    (e.Navbar = {
            ...
            o.forEach((n) => {
                e.Navbar.mobile(t),
                    ...
                    window.addEventListener("resize", function (s) {
                        a.main < e.Win.width && e.Navbar.hide(o, t),
                            e.Navbar.mobile(t);
                    }),
                    document.addEventListener("mouseup", function (a) {
                        null === a.target.closest("." + s.base) &&
                            e.Navbar.hide(o, t);
                    });
            }),
        ...
        (e.CurrentLink = function (t, s, a, o, n, r) {
            let i = document.querySelectorAll(t),
                ...
                d = c.substring(
                    0,
                    -1 == c.indexOf("?") ? c.length : c.indexOf("?")
                );
            ...
            t.length > 0 &&
                t.forEach((e) => {
                    let t = e.dataset.breakpoints
                        ...
                        i = e.dataset.spaceBetween
                            ? parseInt(e.dataset.spaceBetween)
                            : 0,
